...
# Logs
LOG_TDIR=/srv/www/lighttpd/minecraft/logs
LOGS_DAYS=14

# Mapping
CARTO_PATH=$MC_PATH/carto
MAPS_PATH=/srv/www/lighttpd/minecraft/maps
CARTO_OPTIONS="-q -s -m 4"
BIOME_PATH=$MC_PATH/BiomeExtractor
MAP_CHANGES=1

MCOVERVIEWER_PATH=$MC_PATH/Overviewer/
MCOVERVIEWER_MAPS_PATH=/srv/www/lighttpd/minecraft/maps/Overview/
